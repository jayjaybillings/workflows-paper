...
Van~Der~Aalst argues that ``workflows'' arose from the needs of businesses to
not only execute tasks but also ``to manage the flow of work through the
organization,'' and managing workflows is the natural evolution from the
...
define a workflow as \todo{Make sure usage of ``grid workflow'' is consistent
across the document.}
